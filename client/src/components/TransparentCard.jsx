...
const TransparentCard = () => {
    return (
        <div className=' space-y-5 lg:w-[80vw] mx-auto my-10 py-10  flex flex-col justify-center items-center'>
            ...
            <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 justify-center items-center'>
                ...
                <div className="card w-96 bg-base-100 shadow-sm">
                    <div className="card-body bg-[#4F39F6] text-white relative ">
                        ...
                        <div className="mt-6">
                            <button className="btn bg-white text-indigo-500 btn-block">Subscribe</button>
                        </div>
                    </div>
                </div>
                <div className="card w-96 bg-base-100 shadow-sm">
